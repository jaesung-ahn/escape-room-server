...
@Value
@ToString
public class GatheringConfirmResDTO {
    ...
    public static GatheringConfirmResDTO fromGatheringRequestDetail(GatheringRequest gatheringRequest, UserProfileResponseDTO profileDTO) {

        return GatheringConfirmResDTO.builder()
